...
- **交互式 CLI**：内置命令行工具，支持自然语言对话和动态 Skill 管理
- **全面日志**：详细的开发和调试日志
...
框架提供了交互式命令行工具，无需编写代码即可与 AI Agent 对话：
...
在 CLI 中，你可以：
- 直接与 AI 对话，使用自然语言提问
- 使用 `/builtin` 加载内置技能（代码审查、数据分析等）
- 使用 `/load` 加载自定义技能文件
- 使用 `/list` 查看已加载的技能
- 输入 `/help` 查看所有可用命令

**[查看完整 CLI 使用文档 →](docs/CLI.md)** | [English CLI Docs](docs/CLI.en.md)
